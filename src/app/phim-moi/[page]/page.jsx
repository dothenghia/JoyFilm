...
export async function generateMetadata({ params }) {
    return {
        title: `Phim mới cập nhật - Trang ${params.page} | JoyFilm`,
    }
}
    ...
    return (
        <div className="page-container-0topside">
            <div className="section-container">
                <h1 className="section-title-no-up">Phim mới cập nhật - Trang {params.page}</h1>
                ...
                <div className="mt-6 flex flex-row flex-wrap justify-center">
                    <PageButtons curr={params.page} total={data.totalPages} url={'phim-moi'} />
                </div>
