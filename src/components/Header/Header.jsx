                    ...
                    <div className="section-container-no-py flex flex-wrap items-center justify-between">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden lg:flex flex-row">
                                <Link href="/phim-moi" className="header-link">Phim mới</Link>
                                <Link href="/chieu-rap" className="header-link">Phim chiếu rạp</Link>
                                <Link href="/phim-le" className="header-link">Phim lẻ</Link>
                                <Link href="/phim-bo" className="header-link">Phim bộ</Link>
                                <Link href="/hoat-hinh" className="header-link">Hoạt hình</Link>
                            </div>
                        ...
                        <div id="navbar-search"
                            ...
                            <div className="font-medium flex flex-col lg:pl-0 mt-4 mb-2 lg:mb-0 lg:flex-row lg:space-x-0 lg:mt-0">
                                <Link href="/phim-moi" onClick={toggleNavbar} className="header-link">Phim mới</Link>
                                <Link href="/chieu-rap" onClick={toggleNavbar} className="header-link">Phim chiếu rạp</Link>
                                <Link href="/phim-le" onClick={toggleNavbar} className="header-link">Phim lẻ</Link>
                                <Link href="/phim-bo" onClick={toggleNavbar} className="header-link">Phim bộ</Link>
                                <Link href="/hoat-hinh" onClick={toggleNavbar} className="header-link">Hoạt hình</Link>
                            </div>
                        </div>
